...
class ChooseClass : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rb5 = findViewById<RadioButton>(R.id.rb7)
        rb6 = findViewById<RadioButton>(R.id.rb8)
        rb7 = findViewById<RadioButton>(R.id.rb5)
        rb8 = findViewById<RadioButton>(R.id.rb6)

        val btnNext = findViewById<Button>(R.id.idNextBtn)
        ...
        btnNext.setOnClickListener {
            ...
            rg1 = findViewById<RadioGroup>(R.id.radioGroup1)
